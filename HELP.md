...
Let's make the API read only to disable create delete and update operations.

Implement the RepositoryRestConfigurer interface and override the configureHttpMethods method.
